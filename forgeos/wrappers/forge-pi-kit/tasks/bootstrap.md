# forge-pi-kit Bootstrap Tasks

Use this checklist to bring Pi online as a ForgeOS contract-first coding agent.

## Phase 1: Profile files

- [ ] Read `forgeos/wrappers/forge-pi-kit/README.md`.
- [ ] Read `forgeos/wrappers/forge-pi-kit/profiles/default.yaml`.
- [ ] Read `forgeos/wrappers/forge-pi-kit/profiles/runpod-vllm.yaml`.
